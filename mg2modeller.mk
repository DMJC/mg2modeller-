...
$(IntermediateDirectory)/src_nurbs.cpp$(ObjectSuffix): src/nurbs.cpp $(IntermediateDirectory)/src_nurbs.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/james/development/mg2modeller/mg2modeller++/src/nurbs.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_nurbs.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_nurbs.cpp$(DependSuffix): src/nurbs.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_nurbs.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/src_nurbs.cpp$(DependSuffix) -MM src/nurbs.cpp

$(IntermediateDirectory)/src_nurbs.cpp$(PreprocessSuffix): src/nurbs.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_nurbs.cpp$(PreprocessSuffix) src/nurbs.cpp

$(IntermediateDirectory)/src_metaball.cpp$(ObjectSuffix): src/metaball.cpp $(IntermediateDirectory)/src_metaball.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/james/development/mg2modeller/mg2modeller++/src/metaball.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_metaball.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_metaball.cpp$(DependSuffix): src/metaball.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_metaball.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/src_metaball.cpp$(DependSuffix) -MM src/metaball.cpp

$(IntermediateDirectory)/src_metaball.cpp$(PreprocessSuffix): src/metaball.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_metaball.cpp$(PreprocessSuffix) src/metaball.cpp

$(IntermediateDirectory)/src_text.cpp$(ObjectSuffix): src/text.cpp $(IntermediateDirectory)/src_text.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/james/development/mg2modeller/mg2modeller++/src/text.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_text.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_text.cpp$(DependSuffix): src/text.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_text.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/src_text.cpp$(DependSuffix) -MM src/text.cpp

$(IntermediateDirectory)/src_text.cpp$(PreprocessSuffix): src/text.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_text.cpp$(PreprocessSuffix) src/text.cpp

$(IntermediateDirectory)/src_draw.cpp$(ObjectSuffix): src/draw.cpp $(IntermediateDirectory)/src_draw.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/james/development/mg2modeller/mg2modeller++/src/draw.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_draw.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/src_draw.cpp$(DependSuffix): src/draw.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/src_draw.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/src_draw.cpp$(DependSuffix) -MM src/draw.cpp

$(IntermediateDirectory)/src_draw.cpp$(PreprocessSuffix): src/draw.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/src_draw.cpp$(PreprocessSuffix) src/draw.cpp

$(IntermediateDirectory)/include_guide.cpp$(ObjectSuffix): include/guide.cpp $(IntermediateDirectory)/include_guide.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/james/development/mg2modeller/mg2modeller++/include/guide.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/include_guide.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/include_guide.cpp$(DependSuffix): include/guide.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/include_guide.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/include_guide.cpp$(DependSuffix) -MM include/guide.cpp

$(IntermediateDirectory)/include_guide.cpp$(PreprocessSuffix): include/guide.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/include_guide.cpp$(PreprocessSuffix) include/guide.cpp
...
$(IntermediateDirectory)/src_gl_toolbar.cpp$(ObjectSuffix): src/gl_toolbar.cpp $(IntermediateDirectory)/src_gl_toolbar.cpp$(DependSuffix)
